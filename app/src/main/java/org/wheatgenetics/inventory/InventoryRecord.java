...
public class InventoryRecord extends java.lang.Object {
    ...
    public InventoryRecord(final String boxID, final String envID,
    final String personID, final String date, final int position, final String wt) {
    ...
    final String personID, final String date, final String position, final String wt) {
        this();
    ...
    public String getBox() { return this.boxID; }

    public void setBox(final String box) { this.boxID = box; }
    ...
    public void setPersonID(final String personID) { this.personID = personID; }
