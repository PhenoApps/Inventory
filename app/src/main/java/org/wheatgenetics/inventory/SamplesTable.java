...
class SamplesTable extends android.database.sqlite.SQLiteOpenHelper {
    ...
    static private String[] makeStringArray(final int value) {
        return org.wheatgenetics.inventory.SamplesTable.makeStringArray(String.valueOf(value));
    }
    ...
    protected InventoryRecord get(final int id) {
        final InventoryRecord inventoryRecord = new InventoryRecord();
        {
            ...
            final Cursor cursor = this.getReadableDatabase().query(
                ...
                /* selectionArgs => */ org.wheatgenetics.inventory.SamplesTable.makeStringArray(id),
                /* groupBy       => */ null                                                        ,
                /* having        => */ null                                                        ,
                /* orderBy       => */ null                                                        ,
                /* limit         => */ null                                                        );
        ...
        int i;
        {
            final SQLiteDatabase db = this.getWritableDatabase();
            {
                ...
                i = db.update(this.TABLE_NAME, contentValues, this.ID_FIELD_NAME + " = ?",
                    org.wheatgenetics.inventory.SamplesTable.makeStringArray(id));
            }
            db.close();
        }
        return i;
    ...
    String getBoxList()
    {
        java.lang.String boxList = null;
        {
            final Cursor cursor = this.getWritableDatabase().query(
                ...
                /* table    => */ this.TABLE_NAME,
                /* columns  => */
                    org.wheatgenetics.inventory.SamplesTable.makeStringArray(this.BOX_FIELD_NAME),
                /* selection     => */ null               ,
                /* selectionArgs => */ null               ,
